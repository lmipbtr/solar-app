...
if uploaded_file is not None:
    ...
    start_date = st.date_input("Enter Start Date", today, min_value = min_date, max_value = max_date)
    #st.write("Start Date is:", start_date)
    
    end_date = st.date_input("Enter End Date", today, min_value = min_date, max_value = max_date)
